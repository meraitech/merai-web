...
export function Hero8() {
  ...
  const line1Full = t("About.hero.line1");
  const line1Parts = line1Full.split(" ");
  const line1Left = line1Parts[0] || "";
  const line1Right = line1Parts.slice(1).join(" ") || "";

  const line2Full = t("About.hero.line2");
  const line2Parts = line2Full.split(" ");
  const line2Left = line2Parts[0] || "";
  const line2Right = line2Parts.slice(1).join(" ") || "";
