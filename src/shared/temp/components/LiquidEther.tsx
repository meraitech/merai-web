...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container: HTMLElement) {
        this.container = container;
        // Dengarkan di window/document agar background boleh pointer-events:none
        ...
        // Hover inside: cek sendiri berdasarkan rect container
        window.addEventListener("mouseenter", this._onMouseEnter as any);
        window.addEventListener("mouseleave", this._onMouseLeave as any);
      }
      dispose() {
        ...
        window.removeEventListener("mouseenter", this._onMouseEnter as any);
        window.removeEventListener("mouseleave", this._onMouseLeave as any);
      }
