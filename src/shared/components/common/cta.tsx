...
import { ArrowRight, Layers, Hexagon, Send } from "lucide-react";
      ...
      <div className="max-w-[1400px] mx-auto w-full">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center  mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-neutral-900 dark:text-white tracking-tight max-w-2xl">
              {t("heading")}
            </h2>
            <p className="mt-3 text-sm max-w-lg sm:text-base text-neutral-700 dark:text-neutral-300">
              {t("description")}
            </p>
            <UiLink
              href="/contact"
              className="mt-6 inline-flex px-6 py-3 rounded-lg bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 text-sm font-medium hover:opacity-90 transition-opacity"
            >
              {t("button")}
            </UiLink>
          </div>
